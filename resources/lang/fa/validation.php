...
return [
   ...
   */
   ...
   'attributes' => [
      ...
      'instagram_url' => 'آدرس پیج اینستاگرام',
      'caller_discount' => 'میزان تخفیف دعوت کننده',
      'invitation_discount' => 'میزان تخفیف دعوت شونده',
      'business_introduction' => 'متن معرفی کسب و کار خود',
      'phone_number' => 'شماره موبایل',
      'full_name' => 'نام و نام خانوادگی',
      'website_url' => 'سایت',
      'instagram_id' => 'آی دی پیج اینستاگرام',
      'telegram_id' => 'آی دی پیج تلگرام',
      'need_referral_number' => 'تعداد ارجاعات برای صدور کد تخفیف',
      'current_referral_number' => 'تعداد ارجاعات تاکنون',
      'customer_discount' => 'درصد/مبلغ هر کد تخفیف مشتری',
      'invited_discount' => 'درصد/مبلغ تخفیف ارجاع شونده'
   ],
];
